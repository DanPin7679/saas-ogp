...
SUBSCRIPTION_PERMISSIONS = [
    ("coach", "Coach Perm"), # subscriptions.advanced
    ("premium", "Premium Perm"), # subscriptions.advanced
    ("basic", "Basic  Perm"),  # subscriptions.pro
    ("free", "Free Perm"),  # subscriptions.basic,
]
